/*
Write a program where you first enter a set of name-and-value pair, such
as Joe 17 and Barbara 22. For each pair, add the name to a vector called 
names and the the number to a vector called scores (in corresponding po-
...
error message if a name is entered twice. Write out all the (name,value)
pairs, one per line
*/
